...
const LandingPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Elite Homecare Partners | Trusted Nannies, Housekeepers & Caregivers</title>
        <meta name="description" content="Elite Homecare Partners provides trusted nannies, governesses, housekeepers, and caregivers in Abuja. Find professional and compassionate home staffing solutions." />
      </Helmet>
      <div>
        ...
        <div>
          <section className="bg-white" data-aos="fade-up">
            <div className="bg-gray-50 border border-gray-200 shadow-md max-w-7xl mx-auto px-6 py-10 text-black space-y-8 text-base sm:text-lg leading-relaxed">
              <h2 className="text-center text-[#1c4c50] text-3xl sm:text-4xl font-bold mb-12 text-gray-900">
