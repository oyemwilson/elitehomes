...
const WhyChooseUs = () => {
  return (
    <>
      <Helmet>
        <title>Why Choose Us | Elite Homecare Partners</title>
        <meta name="description" content="Discover why Elite Homecare Partners is the preferred choice for domestic staffing, offering thoroughly vetted professionals, personalized matching, and exceptional standards." />
      </Helmet>
